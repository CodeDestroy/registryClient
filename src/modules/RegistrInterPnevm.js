...
const Accordion = styled((props) => (
  ...
  function RegistrInterPnevm() {
    ...
    useEffect(() => {
        ...
        DataService.fetchCoursePulm().then((res) => {
            setCourses(res.data)
        })
    ...
    const [initTherapyDate, setInitTherapyDate] = useState(new Date());
    const [controlVisitNumber, setControlVisitNumber] = useState('');
    const [controlVisitDate, setControlVisitDate] = useState(new Date());
    ...
    const handleChangeSelectcourseId = (event) => {
    ...
    const sendDataRegInterPnevm = () => {
         ...
         .then((res) => {
            ...
            setFlowType('');
            setcourseId(0);
            setInitTherapyDate(new Date());
            setControlVisitNumber('');
            setControlVisitDate(new Date());
            setMMRScontrol('');
            setFJELcontrol('');
            setDLCOcontrol('');
            setComments('');
                ...
                <AccordionDetails>
                    ...
                    <Typography>
                        ...
                        <FormControl variant="standard" sx={{ m: 1, minWidth: 250 }}>
                            ...
                            >                           
                            <MenuItem value={'Обычной интерстициальной пневмонии'}>Обычной интерстициальной пневмонии</MenuItem>
                            <MenuItem value={'Вероятной интерстициальной пневмонии'}>Вероятной интерстициальной пневмонии</MenuItem>                           
                            </Select>
                        </FormControl>
                        <TextField
                            id="mMRS-inp"
                        ...
                        <FormControl variant="standard" sx={{ m: 1, minWidth: 250 }}>
                            ...
                            >                           
                            <MenuItem value={'Идиопатический легочный фиброз'}>Идиопатический легочный фиброз</MenuItem>
                            <MenuItem value={'Интерстициальное заболевание с фиброзированием, неуточненное'}>Интерстициальное заболевание с фиброзированием, неуточненное</MenuItem>    
                            <MenuItem value={'Интерстициальное заболевание с фиброзированием, ассоциированное с системным заболеванием соединительной ткани'}>Интерстициальное заболевание с фиброзированием, ассоциированное с системным заболеванием соединительной ткани</MenuItem>                          
                            </Select>
                        </FormControl>                     
                         <FormControl variant="standard" sx={{ m: 1, minWidth: 250 }}>
                            <InputLabel id="courseId-lab">Препарат</InputLabel>
                            <Select
                            labelId="courseId-lab"
                            id="courseId-inp"
                            value={courseId}
                            onChange={handleChangeSelectcourseId}
                            label="Препарат"
                            >       
                            {courses.map((course) => (
